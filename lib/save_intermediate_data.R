...
#' @description A function to drop unwanted samples from the tree and convert
#'  PSM_ID into ERIN_ID. 
#'
...
#' @description A function to drop unwanted samples from the matrix and convert
#'  PSM_ID into ERIN_ID. 
#'
...
#' Simplify the SNP code matrix to be binary
#' @description This function converts a matrix with single nucleotide variants 
#'   that are encoded with various features (filtered, unmapped, phage, FQ, MQ) 
#'   andcreates an easier to interpret version: either the variant is present 
#'   (1) or it is absent (0). 
#'
...
#' Save data for trehalose analysis
#' @description Given all of the input data, saves a tibble and a tree with all 
#'   of the relevant data and only the good samples. 
